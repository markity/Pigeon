...
var file_service_im_relay_proto_rawDesc = []byte{
	...
	0x74, 0x70, 0x75, 0x74, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x32, 0x88, 0x02, 0x0a,
...
var file_service_im_relay_proto_goTypes = []interface{}{
	...
	(*evloopio.UniversalGroupEvloopInput)(nil),  // 7: evloopio.UniversalGroupEvloopInput
	(*evloopio.UniversalGroupEvloopOutput)(nil), // 8: evloopio.UniversalGroupEvloopOutput
}
var file_service_im_relay_proto_depIdxs = []int32{
	6, // 0: imrelay.BizMessageReq.session:type_name -> base.SessionEntry
	7, // 1: imrelay.RedirectToChatEventLoopReq.input:type_name -> evloopio.UniversalGroupEvloopInput
	8, // 2: imrelay.RedirectToChatEventLoopResp.output:type_name -> evloopio.UniversalGroupEvloopOutput
	...
	1, // 6: imrelay.IMRelay.BizMessage:output_type -> imrelay.BizMessageResp
	3, // 7: imrelay.IMRelay.CreateChatEventLoop:output_type -> imrelay.CreateChatEventLoopResp
	5, // 8: imrelay.IMRelay.RedirectToChatEventLoop:output_type -> imrelay.RedirectToChatEventLoopResp
