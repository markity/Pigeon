...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"GetGroupMemberInfo": kitex.NewMethodInfo(
		getGroupMemberInfoHandler,
		newGetGroupMemberInfoArgs,
		newGetGroupMemberInfoResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
}
...
func getGroupMemberInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(imrelation.GetGroupMemberInfoReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(imrelation.IMRelation).GetGroupMemberInfo(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetGroupMemberInfoArgs:
		success, err := handler.(imrelation.IMRelation).GetGroupMemberInfo(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetGroupMemberInfoResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetGroupMemberInfoArgs() interface{} {
	return &GetGroupMemberInfoArgs{}
}

func newGetGroupMemberInfoResult() interface{} {
	return &GetGroupMemberInfoResult{}
}

type GetGroupMemberInfoArgs struct {
	Req *imrelation.GetGroupMemberInfoReq
}

func (p *GetGroupMemberInfoArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(imrelation.GetGroupMemberInfoReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *GetGroupMemberInfoArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *GetGroupMemberInfoArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *GetGroupMemberInfoArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetGroupMemberInfoArgs) Unmarshal(in []byte) error {
	msg := new(imrelation.GetGroupMemberInfoReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetGroupMemberInfoArgs_Req_DEFAULT *imrelation.GetGroupMemberInfoReq

func (p *GetGroupMemberInfoArgs) GetReq() *imrelation.GetGroupMemberInfoReq {
	if !p.IsSetReq() {
		return GetGroupMemberInfoArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetGroupMemberInfoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetGroupMemberInfoArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetGroupMemberInfoResult struct {
	Success *imrelation.GetGroupMemberInfoResp
}

var GetGroupMemberInfoResult_Success_DEFAULT *imrelation.GetGroupMemberInfoResp

func (p *GetGroupMemberInfoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(imrelation.GetGroupMemberInfoResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *GetGroupMemberInfoResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *GetGroupMemberInfoResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *GetGroupMemberInfoResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetGroupMemberInfoResult) Unmarshal(in []byte) error {
	msg := new(imrelation.GetGroupMemberInfoResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetGroupMemberInfoResult) GetSuccess() *imrelation.GetGroupMemberInfoResp {
	if !p.IsSetSuccess() {
		return GetGroupMemberInfoResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetGroupMemberInfoResult) SetSuccess(x interface{}) {
	p.Success = x.(*imrelation.GetGroupMemberInfoResp)
}

func (p *GetGroupMemberInfoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetGroupMemberInfoResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) GetGroupMemberInfo(ctx context.Context, Req *imrelation.GetGroupMemberInfoReq) (r *imrelation.GetGroupMemberInfoResp, err error) {
	var _args GetGroupMemberInfoArgs
	_args.Req = Req
	var _result GetGroupMemberInfoResult
	if err = p.c.Call(ctx, "GetGroupMemberInfo", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
