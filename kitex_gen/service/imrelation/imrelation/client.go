...
type Client interface {
	...
	GetGroupMemberInfo(ctx context.Context, Req *imrelation.GetGroupMemberInfoReq, callOptions ...callopt.Option) (r *imrelation.GetGroupMemberInfoResp, err error)
}
...
func (p *kIMRelationClient) GetGroupMemberInfo(ctx context.Context, Req *imrelation.GetGroupMemberInfoReq, callOptions ...callopt.Option) (r *imrelation.GetGroupMemberInfoResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetGroupMemberInfo(ctx, Req)
}
